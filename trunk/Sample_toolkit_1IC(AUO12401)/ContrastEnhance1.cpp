...
void __fastcall TContrastEnhanceForm1::JND_WriteClick(TObject *Sender)
{
        ...
        EngineerForm->SetWrite_PG(JND_addr[0], JND_lut, JND_addr[0].LutNum());
}
...
void __fastcall TContrastEnhanceForm1::ST_WriteClick(TObject *Sender)
{
        ...
        EngineerForm->SetWrite_PG(ST_addr[0], ST_lut, ST_addr[0].LutNum());
}
...
void __fastcall TContrastEnhanceForm1::MAX_WriteClick(TObject *Sender)
{
        ...
        EngineerForm->SetWrite_PG(MAX_addr[0], MAX_lut, MAX_addr[0].LutNum());
}
//---------------------------------------------------------------------------
...
void __fastcall TContrastEnhanceForm1::MIN_WriteClick(TObject *Sender)
{
        ...
        EngineerForm->SetWrite_PG(MIN_addr[0], MIN_lut, MIN_addr[0].LutNum());
}
//---------------------------------------------------------------------------
...
{
        EngineerForm->SetRead_PG(JND_addr[0], JND_lut, JND_addr[0].LutNum());
        for(int i = 0; i < 16; i++)
...
{
        EngineerForm->SetRead_PG(ST_addr[0], ST_lut, ST_addr[0].LutNum());
        for(int i = 0; i < 16; i++)
...
{
        EngineerForm->SetRead_PG(MAX_addr[0], MAX_lut, MAX_addr[0].LutNum());
        for(int i = 0; i < 16; i++)
...
{
        EngineerForm->SetRead_PG(MIN_addr[0], MIN_lut, MIN_addr[0].LutNum());
        for(int i = 0; i < 16; i++)
...
void __fastcall TContrastEnhanceForm1::FormKeyDown(TObject *Sender,
...
void __fastcall TContrastEnhanceForm1::FormClose(TObject *Sender,
      TCloseAction &Action)
{
        delete [] OCE;
        Action = caFree;
