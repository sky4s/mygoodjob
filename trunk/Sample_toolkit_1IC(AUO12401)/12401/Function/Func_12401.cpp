...
TLUT* Func_12401::SetODLUT1()
{
        TLUT* LUT = new TLUT [4];
        if(MainForm->addr_place == 0){
                SetAddr(&LUT[0],OD1_data1);
                SetAddr(&LUT[1],OD1_data2);
                SetAddr(&LUT[2],OD1_data3);
                SetAddr(&LUT[3],OD1_data4);
        }else if(MainForm->addr_place == 1){
                GetAddr(&LUT[0],"OD1_data1");
                GetAddr(&LUT[1],"OD1_data2");
                GetAddr(&LUT[2],"OD1_data3");
                GetAddr(&LUT[3],"OD1_data4");
        }
        return LUT;
}
TLUT* Func_12401::SetODLUT2()
{
        TLUT* LUT = new TLUT [4];
        if(MainForm->addr_place == 0){
                SetAddr(&LUT[0],OD2_data1);
                SetAddr(&LUT[1],OD2_data2);
                SetAddr(&LUT[2],OD2_data3);
                SetAddr(&LUT[3],OD2_data4);
        }else if(MainForm->addr_place == 1){
                GetAddr(&LUT[0],"OD2_data1");
                GetAddr(&LUT[1],"OD2_data2");
                GetAddr(&LUT[2],"OD2_data3");
                GetAddr(&LUT[3],"OD2_data4");
        }
        return LUT;
}
