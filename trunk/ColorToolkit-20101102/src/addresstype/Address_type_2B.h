...
class TBit2:public AbstractAddressType {
  ...
  public:
    ...
    int Divide();
    int GetVal();
    int_array getValues(int value);
    void SetVal(int);
     TBit2();
     TBit2(int _B_addr1, int _B_addr2, int _b_num, int _b1_addr, AnsiString _name);
...
int_array TBit2::getValues(value)
{
    ...
    values[0] = Byte1.GetVal();
    values[1] = Byte2.GetVal();
    return values;
};
...
TBit2::TBit2(int _B_addr1, int _B_addr2, int _b_num, int _b1_addr, AnsiString _name)
{
    set(_B_addr1, _B_addr2, _b_num, _b1_addr, _name);
};
