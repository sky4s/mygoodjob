...
__fastcall TC3D999Form1::TC3D999Form1(TComponent* Owner)
        : TForm(Owner)
{
        C3D_Chg = 0;
        C3DEN_idx = -1;
...
void __fastcall TC3D999Form1::CheckBox_Click(TObject *Sender)
{
        if(C3D_Chg==0)
                return;
...
//---------------------------------------------------------------------------
void __fastcall TC3D999Form1::FormCreate(TObject *Sender)
{
        C3D_Chg = 0;
        int ic_choice;
...
//---------------------------------------------------------------------------
void __fastcall TC3D999Form1::FormClose(TObject *Sender, TCloseAction &Action)
{
        delete [] OC3D;
        delete [] ChkB;
        delete [] Addr_LUT;
...
//---------------------------------------------------------------------------
void TC3D999Form1::Initial_C3D_table()
{
 ...
 bool TC3D999Form1::c3d_lutArrange()
{
        int idx = 0;
...
void __fastcall TC3D999Form1::btn_C3D_readClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TC3D999Form1::btn_C3D_wrtClick(TObject *Sender)
{
        C3D_LUT_FuncEnable(0);           // Table operation button disable
        bool ok = C3D_LUT_RW_start();    // Record the state of C3D enable
        if(ok==0){                       // Fail to record the state
...
bool TC3D999Form1::C3D_LUT_RW_start()
{
        if(C3DEN_idx==-1){
...
void TC3D999Form1::C3D_LUT_RW_over(){
        // reload en state
...
void TC3D999Form1::C3D_LUT_FuncEnable(bool en_flag)
{
...
void __fastcall TC3D999Form1::btn_C3D_saveClick(TObject *Sender)
{
...
void __fastcall TC3D999Form1::btn_C3D_loadClick(TObject *Sender)
{
        C3D_LUT_FuncEnable(0);
        String Fpath;
...
void __fastcall TC3D999Form1::OnKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
        if(Key == 0x40)
...
void __fastcall TC3D999Form1::Btn_C3D_reloadClick(TObject *Sender)
{
