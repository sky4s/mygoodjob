...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::ScrollBar_Scroll(TObject * Sender, TScrollCode ScrollCode, int &ScrollPos)
{
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::ScrollBar2_Scroll(TObject * Sender, TScrollCode ScrollCode,
					    int &ScrollPos)
{
    TCheckBox *c = (TCheckBox *) Sender;
    int idx = StrToInt(c->Hint);
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::CheckBox_Click(TObject * Sender)
{
    if (IsChg == 0)
	return;
    TCheckBox *c = (TCheckBox *) Sender;
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::ComboBox_Click(TObject * Sender)
{
    if (IsChg == 0)
	return;
...
void __fastcall TSaturationForm::LblE3_KeyPress(TObject * Sender, char &Key)
{
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::LblE4_KeyPress(TObject * Sender, char &Key)
{
    TLabeledEdit *c = (TLabeledEdit *) Sender;
    int idx = StrToInt(c->Hint);
...
void __fastcall TSaturationForm::FormCreate(TObject * Sender)
{
    int ic_choice;
    ...
    cb = OSATForm->SetChkBx();
    ChkB = new _CHKB *[OSATForm->ChkBox_Nbr];
    for (int i = 0; i < OSATForm->ChkBox_Nbr; i++)
	ChkB[i] = new _CHKB;
    ...
    cbo = OSATForm->SetCboBx();

    CboB = new _CBOB *[OSATForm->CboBox_Nbr];
    for (int i = 0; i < OSATForm->CboBox_Nbr; i++)
	CboB[i] = new _CBOB;
    ...
    scrlb = OSATForm->SetScrollBar();

    ScrlB = new _ScrollBar *[OSATForm->ScrollBar_Nbr];
    for (int i = 0; i < OSATForm->ScrollBar_Nbr; i++)
    ...
    scrlb2 = OSATForm->SetScrollBar2();

    ScrlB2 = new _ScrollBar2 *[OSATForm->ScrollBar2_Nbr];
    for (int i = 0; i < OSATForm->ScrollBar2_Nbr; i++) {
    ...
    //LabeledEdit3
    lble3 = OSATForm->SetLblE3();

    LblE3 = new _LBLE3 *[OSATForm->LblE3_Nbr];
    for (int i = 0; i < OSATForm->LblE3_Nbr; i++)
	LblE3[i] = new _LBLE3;
    ...
    // LblE4
    lble4 = OSATForm->SetLblE4();

    LblE4 = new _LBLE4 *[OSATForm->LblE4_Nbr];
    for (int i = 0; i < OSATForm->LblE4_Nbr; i++)
	LblE4[i] = new _LBLE4;
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::FormClose(TObject * Sender, TCloseAction & Action)
{
    delete[]OSATForm;
    delete[]cb;
    delete[]ChkB;
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::btn_reloadClick(TObject * Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TSaturationForm::FormKeyDown(TObject * Sender, WORD & Key, TShiftState Shift)
{
    if (Key == 0x40)
