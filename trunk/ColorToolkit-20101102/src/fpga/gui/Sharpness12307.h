...
#ifndef Sharpness12307H
#define Sharpness12307H
//---------------------------------------------------------------------------
...
======================================================================*/
class TSharpnessForm12307:public TForm
{
...
public:                        // User declarations
   __fastcall TSharpnessForm12307(TComponent * Owner);
  /*
     Sharpness 頁面使用的變數
...
//---------------------------------------------------------------------------
extern PACKAGE TForm *Sharpness12307Form;
//---------------------------------------------------------------------------
