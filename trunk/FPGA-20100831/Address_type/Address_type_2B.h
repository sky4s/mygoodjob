...
class TBit2
{
        ...
        public:
                ...
                int set(int _B1_addr, int _b1_addr, int _b1_num, int _B2_addr, int _b2_addr, int _b2_num, AnsiString _name);
                AnsiString Name();
                TBit2()
                {
                        en = false;
...
//====================================================================================================
int TBit2::set(int _B1_addr, int _b1_addr, int _b1_num, int _B2_addr, int _b2_addr, int _b2_num, AnsiString _name)
{
        en = true;
...
int TBit2::BitNum() { return b_num; }
int TBit2::Divide() { return divide; }
bool TBit2::FuncEn() { return (en); }
AnsiString TBit2::Name() { return name; }
