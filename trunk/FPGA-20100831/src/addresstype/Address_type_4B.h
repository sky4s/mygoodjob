...
class TBit4
{
        ...
        public:
                ...
                int set(int _B1_addr, int _b1_addr, int _b1_num,
                        ...
                        int _B4_addr, int _b4_addr, int _b4_num,
                        AnsiString _name);
                AnsiString Name();
                TBit4()
                {
...
int TBit4::Divide1() { return divide1; }
int TBit4::Divide2() { return divide2; }
int TBit4::Divide3() { return divide3; }
AnsiString TBit4::Name() { return name; }
bool TBit4::FuncEn() { return (en); }
int TBit4::BitNum() { return b_num; }
int TBit4::GetVal()
{
        if(Byte1.GetVal()==-1 || Byte2.GetVal()==-1 || Byte3.GetVal()==-1 || Byte4.GetVal()==-1)
                value = -1;
        else
