...
void __fastcall TForm3::sb_c3d_sim_H_stepChange(TObject *Sender)
{
        ResetClickAdj();
...
void __fastcall TForm3::sb_c3d_sim_S_stepChange(TObject *Sender)
{
        ResetClickAdj();
...
void __fastcall TForm3::sb_c3d_sim_V_stepChange(TObject *Sender)
{
        ResetClickAdj();
