...
#ifndef color_converterH
#define color_converterH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TForm_in_target : public TForm
{
...
public:		// User declarations
        __fastcall TForm_in_target(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TForm_in_target *Form_in_target;
//---------------------------------------------------------------------------
#endif
