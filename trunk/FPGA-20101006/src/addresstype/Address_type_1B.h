...
int TBit::GetVal() { return value; }
void TBit::SetVal(int val) { value = val; } ;
int TBit::BitNum() { return b_num; }
bool TBit::FuncEn() { return (en); }
int TBit::Addr() { return (B_addr); }
int TBit::ShiftBit() { return (b_addr); }
AnsiString TBit::Name() { return name; }
