...
namespace cms
{
  namespace measure
  {
    ...
    public:
      ...
      static void meterCalibrate(boost::shared_ptr <
    ...
    //None, Component, Patch EnumerationEnd()
     ...
     Enumeration(FlickerMode)
      FMA, JEITA EnumerationEnd() class MeterMeasurement
    {
    ...
    public:
      ...
      __property int AverageTimes = { read = averageTimes, write =
          averageTimes };
      __property Patch_vector_ptr MeasurePatchVector = { read =
          measurePatchVector };
    ...
    public:
      ...
      Patch_vector_ptr rampMeasure(const Dep::Channel & channel,
                                   ...
                                   cms::lcd::calibrate::MeasureCondition >
                                   measureCondition);
      Patch_vector_ptr rampMeasure(bptr <
                                   cms::lcd::calibrate::MeasureCondition >
                                   measureCondition);
      ...
      int getMaxZDGCode(bptr < cms::lcd::calibrate::MeasureCondition >
                        measureCondition);
      static int getMaxZDGCode(bptr < cms::measure::MeterMeasurement > mm,
                               bptr < cms::lcd::BitDepthProcessor > bitDepth);
      static int getMaxBIntensityRawGrayLevel(bptr <
