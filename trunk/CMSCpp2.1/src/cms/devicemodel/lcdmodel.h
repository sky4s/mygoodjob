...
namespace cms {
	...
	class DeltaEReport {
	  private:
	    ...
	    Patch_vector_ptr patchList1, patchList2;
	     DeltaEReport();
	  public:
	    static bptr < DeltaEReport >
		getDeltaEReport(Patch_vector_ptr patchList1,
	...
	class DeviceCharacterizationModel {
	  ...
	  public:
	    ...
	    Patch_vector_ptr produceForwardModelPatchList(Patch_vector_ptr
							  rgbPatchList);
	...
	class LCDModel:public DeviceCharacterizationModel {
	  ...
	  public:
	    __property LCDTarget_ptr LCDTarget = {
	    read = lcdTarget};
	};
	...
	class MultiMatrixModel:public LCDModel {
	  ...
	  public:
	    ...
	    static XYZ_ptr recover(XYZ_ptr rXYZ, XYZ_ptr gXYZ,
	...
	class DeHook2LCDModel:public LCDModel {
	  private:
	    XYZ_ptr interpolate(Patch_ptr patch1, Patch_ptr patch2,
