...
namespace cms {
	...
	namespace depend {
	    ...
	    const MaxValue & MaxValue::Double1 = MaxValue(1.);	//タ砏て
	    const MaxValue & MaxValue::Double100 = MaxValue(100.);	//タ砏て
	    ...
	    const MaxValue & MaxValue::Int8Bit = MaxValue(255., true, true, 8);	//盽ノRGB code
	    const MaxValue & MaxValue::Double255 = MaxValue(255.);	//贺bit计RGB code硄ノ
	    const MaxValue & MaxValue::Double256 = MaxValue(256.);	//贺bit计RGB code硄ノ
	    ...
	    const MaxValue & MaxValue::DoubleUnlimited = MaxValue(std::numeric_limits < double >::max());	//礚
