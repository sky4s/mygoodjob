    ...
    namespace depend
    {
      ...
      protected:
        ...
        static double_array XYZ2LinearRGBValues(double_array XYZValues,
                                                const RGBColorSpace &
                                                colorSpace);
        static RGB_ptr XYZ2LinearRGB(XYZ_ptr XYZ,
       ...
       Enumeration(CSType)
        ...
        EktaSpacePS5RGB, Unknow, AdobeRGBD50, AdobeRGB1998, SMPTE_C,
        EnumerationEnd();
      ...
      public:
        ...
        static double_array toLinearRGBValues(double_array RGBValues,
                                              double gamma);
      ...
      private:
          ...
          integer(integer), divisible(divisible), bit(bit)
        {
         ...
         MaxValue(double max):max(max), integer(false), divisible(false),
          bit(-1)
        {
        };
      ...
      {
      public:
        ColorAppearanceBase(const RGBColorSpace & colorSpace,
                            double_array values, int_array lshIndex);
