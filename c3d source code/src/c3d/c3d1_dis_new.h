...
#ifndef c3d1_dis_newH
#define c3d1_dis_newH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#if 0
//rgb <-> hsi
void rgb2hsv(double r, double g, double b, double *h, double *s, double *blank, double *i)
{
...
//---------------------------------------------------------------------------
//rgb <-> hsi
bool hsv2rgb(double h, double s, double i, double *r, double *g, double *b)
{
    i = i / 256;
