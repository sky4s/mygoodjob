...
#ifndef THSVStepSimFormH
#define THSVStepSimFormH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class THSVStepSimForm : public TForm
{
...
public:		// User declarations
        __fastcall THSVStepSimForm(TComponent* Owner);
        void ResetClickAdj();        
};
//---------------------------------------------------------------------------
extern PACKAGE THSVStepSimForm *HSVStepSimForm;
//---------------------------------------------------------------------------
#endif
