...
int tbl_step = 360 / 24;
//---------------------------------------------------------------------------
__fastcall THSVV1Form::THSVV1Form(TComponent * Owner)
:TForm(Owner)
{
    HSV_Chg = 0;
    HSVEN_idx = -1;
...
//---------------------------------------------------------------------------
void __fastcall THSVV1Form::CheckBox_Click(TObject * Sender)
{
    if (HSV_Chg == 0)
	return;
...
void __fastcall THSVV1Form::FormCreate(TObject * Sender)
{
    HSV_Chg = 0;
    /*int ic_choice;
...
void __fastcall THSVV1Form::FormClose(TObject * Sender, TCloseAction & Action)
{
    delete[]OHSV;
    delete[]cb;
    delete[]ChkB;
...
void THSVV1Form::Initial_HSV_table()
{
...
//---------------------------------------------------------------------------
void __fastcall THSVV1Form::cb_Hue_RedClick(TObject * Sender)
{				// 6 Color Adjust : Red
...
void __fastcall THSVV1Form::cb_Hue_YellowClick(TObject * Sender)
...
void __fastcall THSVV1Form::cb_Hue_GreenClick(TObject * Sender)
...
void __fastcall THSVV1Form::cb_Hue_BlueClick(TObject * Sender)
{				// 6 Color Adjust : Blue
...
void __fastcall THSVV1Form::cb_Hue_CyanClick(TObject * Sender)
{				// 6 Color Adjust : Cyan
...
void __fastcall THSVV1Form::cb_Hue_MagClick(TObject * Sender)
...
void __fastcall THSVV1Form::ed_Hue_CustomChange(TObject * Sender)
{
    Set_6HSV_grid();
}
...
void __fastcall THSVV1Form::btn_resetClick(TObject * Sender)
{
    Initial_HSV_table();
}

void THSVV1Form::show_gain(int h, int s, int v)
{
...
void THSVV1Form::Get_Adj_tbl(int *tmp_H, int *tmp_S, int *tmp_V, int tbl_idx)
{
    for (int i = -4; i <= 4; i++) {
...
void THSVV1Form::Set_Adj_tbl(int *tmp_H, int *tmp_S, int *tmp_V, int tbl_idx)
{
    for (int i = -4; i <= 4; i++) {
...
bool THSVV1Form::CheckDif(int &high, int &low, int *tmp_H, int gain)
{
...
bool THSVV1Form::CheckHueIncrease(int high, int low, int *tmp_H)
{
    bool ok = true;
...
void __fastcall THSVV1Form::btn_hsv_loadClick(TObject * Sender)
{
...
bool THSVV1Form::Load_HSV(String Fpath)
{
    if (Fpath == NULL) {
	return 0;
    }
...
void __fastcall THSVV1Form::btn_hsv_saveClick(TObject * Sender)
{
...
void __fastcall THSVV1Form::Hue_ImgMouseMove(TObject * Sender, TShiftState Shift, int X, int Y)
{
    int color;
...
void __fastcall THSVV1Form::btn_Hue_Img_loadClick(TObject * Sender)
{
    if (!OpenDialog1->Execute())
	return;
    String Fpath;
...
void __fastcall THSVV1Form::rg_HSV_ModeClick(TObject * Sender)
{
    String Fpath;
...
void __fastcall THSVV1Form::Btn_HSV_reloadClick(TObject * Sender)
{
...
void __fastcall THSVV1Form::FormKeyDown(TObject * Sender, WORD & Key, TShiftState Shift)
{
    if (Key == 0x40) {
...
void __fastcall THSVV1Form::sb_dif_nChange(TObject * Sender)
{
...
void __fastcall THSVV1Form::sb_dif_pChange(TObject * Sender)
{
...
void __fastcall THSVV1Form::btn_setClick(TObject * Sender)
{
    for (int i = 0; i < 24; i++) {
...
void __fastcall THSVV1Form::btn_hsv_writeClick(TObject * Sender)
{
    Hue_LUTWrite();
}
...
bool THSVV1Form::HSV_LUT_RW_start()
{
    if (HSVEN_idx == -1) {
...
void THSVV1Form::HSV_LUT_RW_over()
{
    // reload en state
...
//---------------------------------------------------------------------------
void THSVV1Form::HSV_LUT_FuncEnable(bool flag_en)
{
...
void __fastcall THSVV1Form::btn_hsv_readClick(TObject * Sender)
{
