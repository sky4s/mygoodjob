...
void __fastcall TGamutSetupForm::ComboBox1Change(TObject * Sender)
{
    int index = ComboBox1->ItemIndex;
    String item = (*ComboBox1->Items)[index];
	...
	Edit_SourceRx->Text = .6227;
	Edit_SourceRy->Text = .3517;
	Edit_SourceRLv->Text = 43.77;
	Edit_SourceGx->Text = .3213;
	Edit_SourceGy->Text = .5991;
	Edit_SourceGLv->Text = 132.6;
	Edit_SourceBx->Text = .1463;
	Edit_SourceBy->Text = .1240;
	Edit_SourceBLv->Text = 36.1;
    }
}
