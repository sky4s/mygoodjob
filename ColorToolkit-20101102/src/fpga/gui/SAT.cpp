...
//---------------------------------------------------------------------------
void __fastcall TSATForm::ScrollBar_Scroll(TObject * Sender, TScrollCode ScrollCode, int &ScrollPos)
{
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::ScrollBar2_Scroll(TObject * Sender, TScrollCode ScrollCode,
					    int &ScrollPos)
{
    TCheckBox *c = (TCheckBox *) Sender;
    int idx = StrToInt(c->Hint);
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::CheckBox_Click(TObject * Sender)
{
    if (IsChg == 0)
	return;
    TCheckBox *c = (TCheckBox *) Sender;
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::ComboBox_Click(TObject * Sender)
{
    if (IsChg == 0)
	return;
...
void __fastcall TSATForm::LblE3_KeyPress(TObject * Sender, char &Key)
{
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::LblE4_KeyPress(TObject * Sender, char &Key)
{
    TLabeledEdit *c = (TLabeledEdit *) Sender;
    int idx = StrToInt(c->Hint);
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::FormClose(TObject * Sender, TCloseAction & Action)
{
    delete[]OSATForm;
    delete[]cb;
    delete[]ChkB;
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::btn_reloadClick(TObject * Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TSATForm::FormKeyDown(TObject * Sender, WORD & Key, TShiftState Shift)
{
    if (Key == 0x40)
