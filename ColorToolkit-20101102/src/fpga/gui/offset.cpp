...
//---------------------------------------------------------------------------
void __fastcall ToffsetForm::ScrollBar_Scroll(TObject *Sender, TScrollCode ScrollCode, int &ScrollPos)
{
...
//---------------------------------------------------------------------------
void __fastcall ToffsetForm::ScrollBar2_Scroll(TObject *Sender, TScrollCode ScrollCode, int &ScrollPos)
{
        TCheckBox *c = (TCheckBox *)Sender;
        int idx = StrToInt(c->Hint);
...
//---------------------------------------------------------------------------
void __fastcall ToffsetForm::FormKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
        if(Key == 0x40)
