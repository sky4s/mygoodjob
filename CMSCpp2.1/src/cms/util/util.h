...
namespace cms
{
  namespace util
  {
    ...
    public:
      ...
      static bool deleteExist(const std::string & filename);
      static bool deleteExist(const char *filename);
      static bool deleteExist(const WideString & filename);
    ...
    public:
      ...
      static string_vector_ptr fromDoubleArray(double2D_ptr doubleArray,
                                               int n);
#endif
      ...
      static bptr < TStringList >
        getTStringListFromTextFile(const std::string & filename);
    ...
    public:
      static void copy(TCanvas * source, TCanvas * dest, int width,
                       int height);
      static bptr < Graphics::TBitmap > getTBitmap(TCanvas * canvas,
