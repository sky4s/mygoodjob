...
namespace cms
{
  namespace colorspace
  {
    namespace depend
    {
      ...
      XYZ_ptr RGBColor::toXYZ(RGB_ptr rgb,
      ...
      double_array RGBColor::toXYZValues(double_array rgbValues,
                                         const RGBColorSpace & rgbColorSpace)
      {
        double_array actualRGBValues =
          toLinearRGBValues(rgbValues, rgbColorSpace.gamma_);
        double_array XYZValues =
          linearToXYZValues(actualRGBValues, rgbColorSpace);
        return XYZValues;
      };
      double_array RGBColor::linearToXYZValues(double_array rgbValues,
                                               ...
                                               rgbColorSpace)
      {
        double2D_ptr XYZValues =
          DoubleArray::times(DoubleArray::toDouble2D(rgbValues, 3),
      ...
      {
        double_array linearRGBValues =
          XYZ2LinearRGBValues(XYZValues, colorSpace);
        double_array rgbValues =
          linearToRGBValues(linearRGBValues, colorSpace);
