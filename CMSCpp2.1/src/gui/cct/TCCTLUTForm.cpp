...
void __fastcall TCCTLUTForm::Button_MeaRunClick(TObject * Sender)
{
	...
	if (true == CheckBox_AbsoluteGamma->Checked) {
	    ...
	    bool absGammasmooth = CheckBox_AbsoluteGammaSmooth->Checked;
	    calibrator.setAbsoluteGamma(absGamma, absGammasmooth);
	}
...
void __fastcall TCCTLUTForm::FormShow(TObject * Sender)
{
	...
	CheckBox_AbsoluteGammaSmooth->Visible = true;
    }
...
{
    CheckBox_AbsoluteGammaSmooth->Enabled =
	CheckBox_AbsoluteGamma->Checked;
}
