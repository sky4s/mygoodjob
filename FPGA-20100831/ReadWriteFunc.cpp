...
//--------------------------------------------------------------------------
int RW_Func::LPT_Read_Byte_Skip_Ack(unsigned char dev_addr, unsigned char* data_addr,
...
int RW_Func::LPT_Read_Byte(unsigned char dev_addr, unsigned char* data_addr,
int data_addr_cnt,unsigned char* data_read)
{
        bool ok = true;
        i2c_start();
...
int RW_Func::USB_connect(int pwr_i, int clck_i)
{
	...
	switch(pwr_i)
	{
		case 0:	ucPowerItem = POWER_EXTERNAL;  break;
		case 1:	ucPowerItem = POWER_INTERNAL_5V; break;
		case 2: ucPowerItem = POWER_INTERNAL_3P3V; break;
		default:ucPowerItem = POWER_INTERNAL_3P3V; break;
	}
	...
	switch(clck_i)
	{
		case 0:	ucSpeedItem = CLOCK_RATE_50KHZ;  break;
		case 1:	ucSpeedItem = CLOCK_RATE_100KHZ; break;
		case 2: ucSpeedItem = CLOCK_RATE_400KHZ; break;
		default:ucSpeedItem = CLOCK_RATE_400KHZ; break;
	}
 ...
 unsigned char* data_read, int data_len, bool overflag)
{
	...
	if(overflag == 0) WriteBuffer[buf_idx++] = I2C_RESTART | I2C_DEV_READ ; //Control Byte
	else WriteBuffer[buf_idx++] = I2C_RESTART | I2C_DEV_READ | I2C_STOP; //Control Byte
...
bool RW_Func::USB_write(unsigned char dev_addr, unsigned char* data_addr, int data_addr_cnt,
...
//---------------------------------------------------------------------------
int RW_Func::LPT_Write(unsigned char dev_addr, unsigned char* data_addr, int data_addr_cnt,
 unsigned char* data_write, int data_len)
{
        bool ok = true;
