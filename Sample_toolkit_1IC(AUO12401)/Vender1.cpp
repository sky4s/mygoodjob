...
void __fastcall TVenderForm1::FormCreate(TObject *Sender)
{
        ...
        /****************************************************************/
        //   Vender CheckBox*4 & ComboBox*7 & ScrollBar*4               //
        /****************************************************************/
        ...
        VendScrlB[0]->Lbl = Label8;
        VendScrlB[0]->StTxt = StaticText1;
        VendScrlB[0]->ScrlB = ScrollBar1;

        VendScrlB[1]->Lbl = Label9;
        VendScrlB[1]->StTxt = StaticText2;
        VendScrlB[1]->ScrlB = ScrollBar2;

        VendScrlB[2]->Lbl = Label10;
        VendScrlB[2]->StTxt = StaticText3;
        VendScrlB[2]->ScrlB = ScrollBar3;
        ...
        VendScrlB2[0]->Lbl = Label11;
        VendScrlB2[0]->StTxt = StaticText4;
        VendScrlB2[0]->ScrlB = ScrollBar4;
